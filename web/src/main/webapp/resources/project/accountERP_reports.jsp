                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">report : financial statement</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                               	<div class="container">
									 ...
									 <div>
									 	<label>검색기준&nbsp;&nbsp;&nbsp;</label>
   										<label class="radio-inline">
   									 		<input type="radio" name="fiscal_type_radio" value="year" checked="checked">&nbsp;연(year)&nbsp;&nbsp;&nbsp;
    									</label>
  									 	<label class="radio-inline">
   									  		<input type="radio" name="fiscal_type_radio" value="month">&nbsp;월(month)&nbsp;&nbsp;&nbsp;
										</label>
    								</div>
    								<hr>
    								<div class="form-group" id="fiscal_year">
 										 <label>검색기간&nbsp;&nbsp;&nbsp;</label>
 										 <select id="year_attr" name="year_attr">
 										 ...
 										 <label>년&nbsp;&nbsp;</label>
 										  <select id="month_attr" name="month_attr" disabled="true">
    								...
    								<div>
    									<label>재무제표&nbsp;&nbsp;&nbsp;</label>
   										<label class="radio-inline">
   									 		<input type="radio" name="fs_select_radio" value="bs" checked="checked">&nbsp;재무상태표&nbsp;&nbsp;&nbsp;
    									</label>
  									 	<label class="radio-inline">
   									  		<input type="radio" name="fs_select_radio" value="is">&nbsp;손익계산서&nbsp;&nbsp;&nbsp;
										</label>
   									 	<label class="radio-inline">
   									   		<input type="radio" name="fs_select_radio" value="cf" disabled="disabled">&nbsp;현금흐름표&nbsp;&nbsp;&nbsp;
    									</label>
    								</div>
    								<hr>
               				 		<div class="input-group">
                 				   <input class="form-control" readonly="readonly" type="text" id="searchText" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2"/>
                 				   <div class="input-group-append">
       ...
       <!--  <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" crossorigin="anonymous"></script> -->
        ...
        <script type="text/javascript">
        	$(function(){
        		...
        		$("input[name='fiscal_type_radio']").click(function(){
					if($(this).val()=='year'){
						$("#month_attr").attr("disabled",true);
						$("#month_attr").prop("selectedIndex",0);
					}
					else if($(this).val()=='month'){
						$("#month_attr").attr("disabled",false);
					}
				});
        		
        		$("button#searchBtn").click(function(){
        			$.ajax({
        				url:'/web/reportSearchAction.do',
        				type:'POST',
        				dataType:'text',
        				contentType:'application/x-www-form-urlencoded;charset=UTF-8',
        				data:{
        					type:$("input[name='fiscal_type_radio']:checked").val(),
        					year:$("select#year_attr").val(),
        					month:$("select#month_attr").val(),
        					fs:$("input[name='fs_select_radio']:checked").val(),
        				},
        				success:function(v){
        					$("#report_content").html(v);
        				},
        				error:function(){
