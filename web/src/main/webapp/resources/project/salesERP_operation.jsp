                            ...
                            <div class="card-body">
                               	<div class="container">
    								...
    								<div>
  										<label>기간 기준&nbsp;&nbsp;&nbsp;</label>
   										<label class="radio-inline">
   									 		<input type="radio" name="date_standard_radio" value="day" disabled="disabled">&nbsp;일간&nbsp;&nbsp;&nbsp;
    									</label>
   									 	<label class="radio-inline">
   									   		<input type="radio" name="date_standard_radio" value="month" disabled="disabled">&nbsp;월간평균&nbsp;&nbsp;&nbsp;
    									</label>
   									 	<label class="radio-inline">
    								...
    								<div>
  										<label>비교 모델&nbsp;&nbsp;&nbsp;</label>
   										<label class="radio-inline">
   									 		<input type="checkbox" name="compare_checkbox" value="소나타">&nbsp;소나타&nbsp;&nbsp;&nbsp;
    									</label>
  									 	<label class="radio-inline">
   									  		<input type="checkbox" name="compare_checkbox" value="그렌저">&nbsp;그렌저&nbsp;&nbsp;&nbsp;
										</label>
   									 	<label class="radio-inline">
   									   		<input type="checkbox" name="compare_checkbox" value="티코">&nbsp;티코&nbsp;&nbsp;&nbsp;
    									</label>
   									 	<label class="radio-inline">
   									   		<input type="checkbox" name="compare_checkbox" value="제네시스">&nbsp;제네시스&nbsp;&nbsp;&nbsp;
    									</label>
    								</div>
    								<hr>
    								<div>
  										<label>분석 대상&nbsp;&nbsp;&nbsp;</label>
   										<label class="radio-inline">
   									 		<input type="radio" name="model_radio" value="all"">&nbsp;전체 모델&nbsp;&nbsp;&nbsp;
    									</label>
  									 	<label class="radio-inline">
   									  		<input type="radio" name="model_radio" value="select" checked="checked">&nbsp;선택 모델&nbsp;&nbsp;&nbsp;
										</label>
    								</div>
               				 		<div class="input-group">
  										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 				   		<input class="form-control" type="text" id="searchText" placeholder="Search for model name..." aria-label="Search" aria-describedby="basic-addon2"/>
                 				    <div class="input-group-append">
       ...
       <!--  <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" crossorigin="anonymous"></script> -->
        ...
        <script type="text/javascript">
        	$(function(){
				...
				$("input[name='model_radio']").click(function(){
					if($(this).val()=='all'){
						$("#searchText").val('');
				...
				$("button#searchBtn").click(function(){
					...
					$.ajax({
						url:'/web/operationChartAction.do',
						type:'POST',
						dataType:'script',
	    				...
	    				data:{
	    					...
	    					compare_model:temp,
	    					select_model:$("input[name='model_radio']:checked").val(),
